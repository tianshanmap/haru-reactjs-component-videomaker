...
function EdgeSection(props){
    ...
    function handleApply(){
        setSource(props.base_url + "edgePreserving/" + props.frame + "/" + sigmaS + "/" + sigmaR)
    }
        ...
        <div className="main">
            <div className="controls">
                <div className="inputs">
                    <lable for="sigma_s">Sigma S(0-200)</lable>
                    <input id="sigma_s" type="number" value={sigmaS} onChange={handleSigmaSChange}/>
                    <lable for="sigma_r">Sigma S(0-1)</lable>
                    <input id="sigma_r" type="number" value={sigmaR} onChange={handleSigmaRChange}/>
                </div>
